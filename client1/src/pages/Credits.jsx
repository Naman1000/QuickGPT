...
const Credits = () => {
    ...
    const fetchPlans = async () => {
     try {
      ...
      if(data.success){
        ...
        toast.error(data.message || "Failed to fetch plnas.")
      }
     } catch (error) {
  ...
  return (
    ...
    lg:px-8 py-12 '>
        <h2 className='text-3xl font-semibold text-center mb-10 xl:mt-10 
            ...
            <div key={plan._id} className={`border border-gray-200 
              ...
              transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id === "pro" ? 
                ...
                <div className='flex-1'>
                  ...
                  mb-2 '>{plan.name}</h3>
                  <p className='text-2xl font-bold text-gray-600 dark:text-purple-300 
                  mb-4'>${plan.price}
