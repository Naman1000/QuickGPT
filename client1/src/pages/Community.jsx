...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-6 xl:px-12 2xl:px-20 w-full mx-auto h-full 
    overflow-y-scroll '>
      <h2 className='text-xl font-semibold mb-6 text-gray-800 
      dark:text-purple-100 '>Community Images</h2>

      {images.length > 0 ? (
        <div className='flex flex-wrap max-sm:justify-around gap-5 '>
            {images.map((item, index)=> (
              ...
              duration-300 '>
                ...
                <p className='absolute bottom-0 text-xs bg-black/50 
                backdrop-blur text-white px-4 py-1 rounded-tl-xl opacity-0 
                group-hover:opacity-100 transitio duration-100 '>
                  Created by Naman  </p>
              </a>
            ))}
          </div>
